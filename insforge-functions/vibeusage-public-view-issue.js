...
var vibeusage_public_view_issue_default = withRequestLogging2("vibeusage-public-view-issue", async function(request) {
  const opt = handleOptions2(request);
  if (opt) return opt;
  return json2({ error: "Endpoint retired" }, 410);
});
export {
  vibeusage_public_view_issue_default as default
};
