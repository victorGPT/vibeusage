...
var vibeusage_public_view_revoke_default = withRequestLogging2("vibeusage-public-view-revoke", async function(request) {
  const opt = handleOptions2(request);
  if (opt) return opt;
  return json2({ error: "Endpoint retired" }, 410);
});
export {
  vibeusage_public_view_revoke_default as default
};
