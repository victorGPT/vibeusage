...
var CORE_KEY5 = "__vibeusageLoggingCore";
...
var vibeusage_leaderboard_settings_default = withRequestLogging2("vibeusage-leaderboard-settings", async function(request) {
  const opt = handleOptions2(request);
  if (opt) return opt;
  return json2({ error: "Endpoint retired" }, 410);
});
export {
  vibeusage_leaderboard_settings_default as default
};
