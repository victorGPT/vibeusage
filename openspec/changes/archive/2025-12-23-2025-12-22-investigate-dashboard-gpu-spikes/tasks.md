...
- [x] 1.2 记录基线：Chrome Task Manager GPU Process，前台静置 60s。
- [x] 1.3 记录 Performance Trace（包含 GPU / Compositor / Paint 轨迹）。
...
- [x] 3.1 输出主因归类（Top 1-2）与证据截图/trace。
- [x] 3.2 给出最小化修复建议（不移除核心视觉）。
- [x] 3.3 若需要代码级诊断开关，提出后续变更建议。
