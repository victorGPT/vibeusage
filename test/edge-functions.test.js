...
test("identity deploy artifacts are built from the ESM pipeline", () => {
  ...
  for (const slug of slugs) {
    ...
    assert.match(content, /import \{ createClient as __insforgeCreateClient \} from "npm:@insforge\/sdk";/);
    assert.match(content, /globalThis\.createClient = __insforgeCreateClient/);
