...
test("sync parses opencode sqlite rows even when message directory is empty", async () => {
  ...
  rollout.parseRolloutIncremental = async () => ({ filesProcessed: 0, eventsAggregated: 0, bucketsQueued: 0 });
  rollout.parseClaudeIncremental = async () => ({ filesProcessed: 0, eventsAggregated: 0, bucketsQueued: 0 });
  rollout.parseGeminiIncremental = async () => ({ filesProcessed: 0, eventsAggregated: 0, bucketsQueued: 0 });
  rollout.parseOpenclawIncremental = async () => ({ filesProcessed: 0, eventsAggregated: 0, bucketsQueued: 0 });
