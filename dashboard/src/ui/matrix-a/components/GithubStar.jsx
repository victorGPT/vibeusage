...
export const GithubStar = ({
  ...
  return (
    ...
    >
      {/* Corner accents */}
      <div className="absolute top-0 left-0 w-1.5 h-1.5 border-t border-l border-ink-muted group-hover:border-ink"></div>
      <div className="absolute bottom-0 right-0 w-1.5 h-1.5 border-b border-r border-ink-muted group-hover:border-ink"></div>
      ...
      <div className="relative">
        <svg
          ...
          viewBox="0 0 16 16"
          width="16"
          className="fill-ink group-hover:scale-110 group-hover:drop-shadow-glow transition-all duration-500"
        >
      ...
      <div className="flex items-center gap-2 leading-none">
        ...
        <span className="text-ink-bright tabular-nums tracking-normal">
          {stars !== null ? stars : "---"}
        </span>
      </div>
      ...
      <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity">
        <div className="absolute top-0 left-0 w-full h-[1px] bg-ink-muted animate-[scanner_2s_linear_infinite]"></div>
      </div>
